...
export default {
  pages: {
    ...
    data: [
      ...
      { title: "ClientView Dashboard", url: "/dashboard/clientview", icon: "HomeIcon", is_bookmarked: false },
      // APPS
      ...
      { title: "Vendor Accounts", url: "/apps/Home/vendoracc", icon: "HomeIcon", is_bookmarked: false }
